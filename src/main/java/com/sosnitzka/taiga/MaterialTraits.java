...
public class MaterialTraits {
    ...
    public static final AbstractTrait soulbound2 = new TraitSoulbound();
    ...
    public static Material aegisalt = new Material("aegisalt", TextFormatting.AQUA).addTrait(soulbound2); //.addTrait(analysing)
